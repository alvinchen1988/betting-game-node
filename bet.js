var game = {
  ...
  bet: function (){
    ...
    if (user_bet_number == random_number){
      ...
      alert("You guess it right! You have earned " + user_bet_amount + "bucks. Total is " + this.initial_amount + "bucks!" )
    }
    else if(user_bet_number == random_number + 1 || user_bet_number == random_number - 1){
      this.initial_amount += 0;
      alert("That was close! you did not earn or lose any money. Total is " + this.initial_amount + "bucks.")
    }
    else{
      this.initial_amount -= user_bet_amount
      ...
      alert("wrong! you lost " + user_bet_amount + "bucks. Total is " + this.initial_amount + "bucks.")
      if (this.initial_amount == 0){
        alert("Game over!")
      }
    }
